...
public class InkVatContainer extends Container
{
	...
	public static List<Integer> getAvailableRecipes(InkVatTileEntity te)
	{
		...
		if(te.hasOmniFilter())
			recipes = getOmniList();
		else for(InkVatColorRecipe recipe : te.getWorld().getRecipeManager().getRecipes(SplatcraftRecipeTypes.INK_VAT_COLOR_CRAFTING_TYPE, te, te.getWorld()))
		{
