...
public class SquidSoulParticle extends SpriteTexturedParticle
{
    ...
    public void renderParticle(IVertexBuilder buffer, ActiveRenderInfo renderInfo, float partialTicks)
    {
        ...
        for(int i = 0; i < 3; i++)
        {
            ...
            buffer.pos((double)lvt_10_1_[0].getX(), (double)lvt_10_1_[0].getY(), (double)lvt_10_1_[0].getZ()).tex(lvt_13_2_, lvt_15_1_).color(r, g, b, a).lightmap(lvt_16_1_).endVertex();
            buffer.pos((double)lvt_10_1_[1].getX(), (double)lvt_10_1_[1].getY(), (double)lvt_10_1_[1].getZ()).tex(lvt_13_2_, lvt_14_1_).color(r, g, b, a).lightmap(lvt_16_1_).endVertex();
            buffer.pos((double)lvt_10_1_[2].getX(), (double)lvt_10_1_[2].getY(), (double)lvt_10_1_[2].getZ()).tex(lvt_12_2_, lvt_14_1_).color(r, g, b, a).lightmap(lvt_16_1_).endVertex();
            buffer.pos((double)lvt_10_1_[3].getX(), (double)lvt_10_1_[3].getY(), (double)lvt_10_1_[3].getZ()).tex(lvt_12_2_, lvt_15_1_).color(r, g, b, a).lightmap(lvt_16_1_).endVertex();
        }
    }
