...
public class SplatCraftItems
{
    ...
    public static final Item splatCharger = new ItemChargerBase("splatCharger", "splat_charger", 0.65f, 8, 0.4f, 50, 60, 32f, 0.4);
    ...
    public static final Item eLiter4K = new ItemChargerBase("eLiter4K", "e_liter_4k", 0.75f, 16, 0.35f, 70, 60, 36f, 0.15);
