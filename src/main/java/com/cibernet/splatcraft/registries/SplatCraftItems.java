...
public class SplatCraftItems
{
    ...
    public static final Item splatRoller = new ItemRollerBase("splatRoller", "splat_roller", -2.5d, 0.4f, 12f, 0.8f, 9f,1.15d, 3, 20, 0.15f, false);
    ...
    public static final Item carbonRoller = new ItemRollerBase("carbonRoller", "carbon_roller", -1.5d, 0.38f, 8f, 0.7f, 3.5f, 1.25d, 2, 14, 0.12f, false);
