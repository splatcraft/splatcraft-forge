...
public class InkTankJrModel extends AbstractInkTankModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "inktankjrmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Tag = Torso.addOrReplaceChild("Tag", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.1168F, 2.8445F, 8.9821F, -0.1309F, -0.3927F, -0.3054F));
