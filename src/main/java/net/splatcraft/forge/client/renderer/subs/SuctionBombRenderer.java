...
public class SuctionBombRenderer extends SubWeaponRenderer<SuctionBombEntity>
{
	public SuctionBombRenderer(EntityRendererProvider.Context renderManager) {
			super(renderManager, new SubWeaponModel<>(), 2);
	}

	@Override
	public void render(GeoModel model, SuctionBombEntity animatable, float partialTick, RenderType type, PoseStack poseStack, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha)
	{
		poseStack.pushPose();
