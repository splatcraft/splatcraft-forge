        ...
        return new WeaponTooltip[]
                {
                        ...
                        new WeaponTooltip<DualieWeaponSettings>("mobility", WeaponTooltip.Metrics.BLOCKS, settings -> settings.rollSpeed * 6, WeaponTooltip.RANKER_DESCENDING) //i used desmos to get that 6 B)
                };
