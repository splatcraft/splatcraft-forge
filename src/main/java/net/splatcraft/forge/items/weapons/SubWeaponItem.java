...
public class SubWeaponItem extends WeaponBaseItem
{
    ...
    public SubWeaponItem(EntityType<? extends AbstractSubWeaponEntity> entityType, WeaponSettings settings, int maxUseTime, SubWeaponAction useTick) {
        super(settings);
    ...
    public SubWeaponItem(EntityType<? extends AbstractSubWeaponEntity> entityType, WeaponSettings settings) {
        this(entityType, settings, USE_DURATION, (stack, useTime) -> {
        });
    }
